...
public class OrderServiceImpl implements OrderService {
	...
	public void updateStatus(String value, String id) {
		...
		if (value.equals("Xác nhận"))
			fieldName = "Confimed";
		else if (value.equals("Đã xong"))
			fieldName = "Finished";
		else if (value.equals("Đã nhận"))
			fieldName = "Received";
		else if (value.equals("Đã lấy"))
			fieldName = "Took";
		else if (value.equals("Đã huỷ"))
			fieldName = "Canceled";
		else if (value.equals("Hoàn thành"))
			fieldName = "Completed";
		deliveryRepository.updateSavedDateByOrderID(fieldName, id);
	}

	@Override
	public List<Order> findByDriver_DriverID(String driverID) {
