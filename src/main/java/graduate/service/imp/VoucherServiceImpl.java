...
import graduate.repository.VoucherRepository;
...
@Override
public void decreaseQuantityByOne(String voucherID) {
	voucherRepository.decreaseQuantityByOne(voucherID);
}



@Override
public Page<Voucher> getAll(Integer pageNo) {
